...
var rimUniform = { type: 'f', value : 0.5 };
var hatch1 = { type: 't', value: THREE.ImageUtils.loadTexture('images/hatch_0.jpg') };
var hatch2 = { type: 't', value: THREE.ImageUtils.loadTexture('images/hatch_1.jpg') };
var hatch3 = { type: 't', value: THREE.ImageUtils.loadTexture('images/hatch_2.jpg') };
var hatch4 = { type: 't', value: THREE.ImageUtils.loadTexture('images/hatch_3.jpg') };
var hatch5 = { type: 't', value: THREE.ImageUtils.loadTexture('images/hatch_4.jpg') };
var hatch6 = { type: 't', value: THREE.ImageUtils.loadTexture('images/hatch_5.jpg') };
...
anisotropicMaterial.uniforms.hatch1.value.wrapS = anisotropicMaterial.uniforms.hatch1.value.wrapT = THREE.RepeatWrapping;
anisotropicMaterial.uniforms.hatch2.value.wrapS = anisotropicMaterial.uniforms.hatch2.value.wrapT = THREE.RepeatWrapping;
anisotropicMaterial.uniforms.hatch3.value.wrapS = anisotropicMaterial.uniforms.hatch3.value.wrapT = THREE.RepeatWrapping;
anisotropicMaterial.uniforms.hatch4.value.wrapS = anisotropicMaterial.uniforms.hatch4.value.wrapT = THREE.RepeatWrapping;
anisotropicMaterial.uniforms.hatch5.value.wrapS = anisotropicMaterial.uniforms.hatch5.value.wrapT = THREE.RepeatWrapping;
anisotropicMaterial.uniforms.hatch6.value.wrapS = anisotropicMaterial.uniforms.hatch6.value.wrapT = THREE.RepeatWrapping;
...
//loadOBJ(Part.ANISOTROPIC, 'obj/armadillo.obj', anisotropicMaterial, 1, 3, 1, 3, 0, 0, 0); // Armadillo
//loadOBJ(Part.ANISOTROPIC, 'obj/bunny.obj', anisotropicMaterial, 1, 3, 0.5, -1, 0, 0, 0);
loadOBJ(Part.ANISOTROPIC, 'obj/car.obj', anisotropicMaterial, 0.04, -3, 0, 3, -1.57, 0, 0.4);
loadOBJ(Part.ANISOTROPIC, 'obj/male.obj', anisotropicMaterial, 0.03, -1, 0, -2, 0, 0, 0);
...
loadOBJ(Part.TOON, 'obj/armadillo.obj', toonMaterial, 1, 3, 1, 3, 0, 0, 0); // Armadillo
loadOBJ(Part.TOON, 'obj/bunny.obj', toonMaterial, 1, 3, 0.5, -1, 0, 0, 0);
loadOBJ(Part.TOON, 'obj/car.obj', toonMaterial, 0.04, -3, 0, 3, -1.57, 0, 0.4);
loadOBJ(Part.TOON, 'obj/male.obj', toonMaterial, 0.03, -1, 0, -2, 0, 0, 0);
