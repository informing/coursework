...
// A macro that determines where the glut header file is located
// For MAC and Linux you should use the package manager to install 
// the libraries. This way it is ensured that the compiler can find them.
// For windows we have provided the header file and the .dll files. The .vcxproj
// file is configured such that it finds these local files.
#if  defined(__APPLE__)
  #define GLUT_INCLUDE_FILE <GLUT/glut.h>
#elif defined(WIN32) || defined(_WIN32)
  #define GLUT_INCLUDE_FILE "glut.h"
#else /* LINUX */
  #define GLUT_INCLUDE_FILE <GL/glut.h>
#endif
