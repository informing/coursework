...
void TriMesh::clear()
{
	...
	std::vector<Vertex*>::iterator it_end = vertices.end();
	for (; it != it_end; ++it)
	{
	    delete *it;
	}
	...
	std::vector<Face*>::iterator it_end = faces.end();
	for (; it != it_end; ++it)
	{
	    delete *it;
	}
    ...
    {
	std::vector<HalfEdge*>::iterator it = edges.begin();
	std::vector<HalfEdge*>::iterator it_end = edges.end();
	for (; it != it_end; ++it)
	{
	    delete *it;
	}
